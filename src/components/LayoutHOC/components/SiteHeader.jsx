...
export function SiteHeader({ title = '' }) {
  return (
    <header className="bg-white/30 dark:bg-black/30 rounded-t-xl backdrop-blur-sm sticky top-0 z-50 flex h-(--header-height) shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
